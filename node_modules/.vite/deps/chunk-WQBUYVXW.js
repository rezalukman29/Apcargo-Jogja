...
var CloseButton = forwardRef(function(props, ref) {
  ...
  var _omitThemingProps = omitThemingProps(props), children = _omitThemingProps.children, isDisabled = _omitThemingProps.isDisabled, __css = _omitThemingProps.__css, rest = _objectWithoutPropertiesLoose2(_omitThemingProps, _excluded);
  var baseStyle = {
    outline: 0,
    display: "flex",
    alignItems: "center",
  ...
  return React.createElement(chakra.button, _extends2({
    type: "button",
    "aria-label": "Close",
    ref,
    disabled: isDisabled,
    __css: _extends2({}, baseStyle, styles, __css)
...
function Portal(props) {
  ...
  return containerRef ? React2.createElement(ContainerPortal, _extends3({
    containerRef
...
function useFeatures(props, visualElement2, preloadedFeatures) {
  ...
  for (var i = 0; i < numFeatures; i++) {
    ...
    if (isEnabled(props) && Component3) {
      features.push(React3.createElement(Component3, __assign({ key: name_1 }, props, { visualElement: visualElement2 })));
    }
  }
  return features;
}
...
function useCreateMotionContext(props, isStatic) {
  var _a = getCurrentTreeVariants(props, (0, import_react12.useContext)(MotionContext)), initial2 = _a.initial, animate3 = _a.animate;
  return (0, import_react12.useMemo)(
    function() {
      return { initial: initial2, animate: animate3 };
    },
    isStatic ? [
      variantLabelsAsDependency(initial2),
...
function createMotionComponent(_a) {
  ...
  function MotionComponent(props, externalRef) {
    ...
    return React4.createElement(
      React4.Fragment,
      null,
      React4.createElement(MotionContext.Provider, { value: context }, useRender(Component3, props, useMotionRef(visualState, context.visualElement, externalRef), visualState, isStatic)),
      features
    );
  }
...
function makeLatestValues(props, context, presenceContext, scrapeMotionValues) {
  ...
  var variantToSet = blockInitialAnimation || initial2 === false ? animate3 : initial2;
...
function AnimateLayoutContextProvider(props) {
  ...
  return React5.createElement(Animate, __assign({}, props, { safeToRemove }));
}
...
var AnimatePresence = function(_a) {
  ...
  if (isInitialRender.current) {
    ...
    return React7.createElement(React7.Fragment, null, filteredChildren.map(function(child) {
      return React7.createElement(PresenceChild, { key: getChildKey(child), isPresent: true, initial: initial2 ? void 0 : false, presenceAffectsLayout }, child);
    }));
  }
  ...
  exiting.forEach(function(key2) {
    ...
    childrenToRender.splice(insertionIndex, 0, React7.createElement(PresenceChild, { key: getChildKey(child), isPresent: false, onExitComplete: onExit, custom, presenceAffectsLayout }, child));
  });
  childrenToRender = childrenToRender.map(function(child) {
    var key2 = child.key;
    return exiting.has(key2) ? child : React7.createElement(PresenceChild, { key: getChildKey(child), isPresent: true, presenceAffectsLayout }, child);
  });
  presentChildren.current = childrenToRender;
  if (exitBeforeEnter && childrenToRender.length > 1) {
    console.warn("You're attempting to animate multiple children within AnimatePresence, but its exitBeforeEnter prop is set to true. This will lead to odd visual behaviour.");
  }
  return React7.createElement(React7.Fragment, null, exiting.size ? childrenToRender : childrenToRender.map(function(child) {
...
var AnimateSharedLayout = function(_super) {
  ...
  AnimateSharedLayout2.prototype.render = function() {
    return React8.createElement(SharedLayoutContext.Provider, { value: this.syncContext }, this.props.children);
  };
...
var variants$4 = {
  exit: function exit2(_ref2) {
    ...
    var animateOpacity = _ref2.animateOpacity, startingHeight = _ref2.startingHeight, transition = _ref2.transition, transitionEnd = _ref2.transitionEnd, delay = _ref2.delay;
    return _extends4({}, animateOpacity && {
      opacity: isNumeric(startingHeight) ? 1 : 0
    }, {
      height: startingHeight,
      transitionEnd: transitionEnd == null ? void 0 : transitionEnd.exit,
      transition: (_transition$exit = transition == null ? void 0 : transition.exit) != null ? _transition$exit : withDelay.exit(defaultTransitions2.exit, delay)
    });
  },
  enter: function enter2(_ref2) {
    ...
    return _extends4({}, animateOpacity && {
      ...
      transition: (_transition$enter = transition == null ? void 0 : transition.enter) != null ? _transition$enter : withDelay.enter(defaultTransitions2.enter, delay)
    });
  }
};
var Collapse = React11.forwardRef(function(props, ref) {
  ...
  var _React$useState = React11.useState(false), mounted = _React$useState[0], setMounted = _React$useState[1];
  ...
  return React11.createElement(AnimatePresence, {
    initial: false,
    custom
  }, show && React11.createElement(motion.div, _extends4({
    ref
  }, rest, {
...
var variants$3 = {
  enter: function enter3(_temp) {
    var _transition$enter;
    var _ref2 = _temp === void 0 ? {} : _temp, transition = _ref2.transition, transitionEnd = _ref2.transitionEnd, delay = _ref2.delay;
    return {
      opacity: 1,
...
var Fade = React11.forwardRef(function(props, ref) {
...
var variants$2 = {
  exit: function exit4(_ref2) {
    var _transition$exit;
    var reverse = _ref2.reverse, initialScale = _ref2.initialScale, transition = _ref2.transition, transitionEnd = _ref2.transitionEnd, delay = _ref2.delay;
    return _extends4({
      opacity: 0
    }, reverse ? {
      scale: initialScale,
...
var ScaleFade = React11.forwardRef(function(props, ref) {
...
var variants$1 = {
  exit: function exit5(_ref2) {
    var _transition$exit;
    var direction = _ref2.direction, transition = _ref2.transition, transitionEnd = _ref2.transitionEnd, delay = _ref2.delay;
    var _slideTransition = slideTransition({
      direction
    }), exitStyles = _slideTransition.exit;
    return _extends4({}, exitStyles, {
...
var Slide = React11.forwardRef(function(props, ref) {
  ...
  return React11.createElement(AnimatePresence, {
    custom
  }, show && React11.createElement(motion.div, _extends4({}, rest, {
    ref,
    initial: "exit",
...
var variants = {
  initial: function initial(_ref2) {
    var _transition$exit;
    var offsetX = _ref2.offsetX, offsetY = _ref2.offsetY, transition = _ref2.transition, transitionEnd = _ref2.transitionEnd, delay = _ref2.delay;
    return {
      opacity: 0,
      x: offsetX,
      y: offsetY,
  ...
  exit: function exit6(_ref3) {
    ...
    }, reverse ? _extends4({}, offset, {
      transitionEnd: transitionEnd == null ? void 0 : transitionEnd.exit
    }) : {
      transitionEnd: _extends4({}, offset, transitionEnd == null ? void 0 : transitionEnd.exit)
    });
  }
};
var slideFadeConfig = {
...
var SlideFade = React11.forwardRef(function(props, ref) {
...
var FocusLock = React17.forwardRef(function FocusLockUI(props, parentRef) {
  ...
  var _React$useState2 = React17.useState({}), id = _React$useState2[0];
...
function MoveFocusInside(_ref2) {
  ...
  return React22.createElement("div", _extends({}, inlineProp(FOCUS_AUTO, !isDisabled), {
    ref,
    className
  }), children);
}
...
var FocusLock2 = function FocusLock3(props) {
  ...
  return React24.createElement(es2015_default2, {
...
var RemoveScroll = React25.forwardRef(function(props, parentRef) {
  ...
  return React25.createElement(
    ...
    forwardProps ? React25.cloneElement(React25.Children.only(children), __assign2({}, containerProps, { ref: containerRef })) : React25.createElement(Container3, __assign2({}, containerProps, { className, ref: containerRef }), children)
  );
});
...
function RemoveScrollSideCar(props) {
  ...
  var shouldCancel = React28.useCallback(function(name, delta2, target, should) {
...
var ReactRemoveScroll = React29.forwardRef(function(props, ref) {
  return React29.createElement(RemoveScroll, __assign2({}, props, { ref, sideCar: sidecar_default }));
});
...
var transitions = {
  slideInBottom: _extends5({}, slideFadeConfig, {
    custom: {
      offsetY: 16,
      reverse: true
    }
  }),
  slideInRight: _extends5({}, slideFadeConfig, {
    custom: {
      offsetX: 16,
      reverse: true
    }
  }),
  scale: _extends5({}, scaleFadeConfig, {
    custom: {
      initialScale: 0.95,
      reverse: true
    }
...
function useModal(props) {
  ...
  var dialogRef = (0, import_react43.useRef)(null);
  var overlayRef = (0, import_react43.useRef)(null);
  ...
  var mouseDownTarget = (0, import_react43.useRef)(null);
  var onMouseDown = (0, import_react43.useCallback)(function(event) {
  ...
  var _useState = (0, import_react43.useState)(false), headerMounted = _useState[0], setHeaderMounted = _useState[1];
  var _useState2 = (0, import_react43.useState)(false), bodyMounted = _useState2[0], setBodyMounted = _useState2[1];
  var getDialogProps = (0, import_react43.useCallback)(function(props2, ref) {
    if (props2 === void 0) {
      props2 = {};
    }
    if (ref === void 0) {
  ...
  var onOverlayClick = (0, import_react43.useCallback)(function(event) {
    event.stopPropagation();
  ...
  var getDialogContainerProps = (0, import_react43.useCallback)(function(props2, ref) {
    if (props2 === void 0) {
      props2 = {};
    }
    if (ref === void 0) {
...
var Modal = function Modal2(props) {
  ...
  return React30.createElement(ModalContextProvider, {
    value: context
  }, React30.createElement(StylesProvider, {
    value: styles
  }, React30.createElement(AnimatePresence, {
    onExitComplete: onCloseComplete
  }, context.isOpen && React30.createElement(Portal, portalProps, children))));
};
Modal.defaultProps = {
...
var ModalContent = forwardRef(function(props, ref) {
  ...
  var dialogContainerStyles = _extends5({
    display: "flex",
    width: "100vw",
    height: "100vh",
  ...
  return React30.createElement(ModalFocusScope, null, React30.createElement(chakra.div, _extends5({}, containerProps, {
    className: "chakra-modal__content-container",
    tabIndex: -1,
    __css: dialogContainerStyles
  }), React30.createElement(ModalTransition, _extends5({
    preset: motionPreset,
...
function ModalFocusScope(props) {
  ...
  return React30.createElement(FocusLock2, {
    autoFocus,
    ...
    lockFocusAcrossFrames
  }, React30.createElement(Combination_default2, {
...
var ModalOverlay = forwardRef(function(props, ref) {
  ...
  return React30.createElement(MotionDiv, _extends5({}, motionProps, {
    __css: overlayStyle,
    ref,
    className: _className
  }, rest));
...
var ModalHeader = forwardRef(function(props, ref) {
  ...
  var styles = useStyles();
  var headerStyles = _extends5({
    flex: 0
  }, styles.header);
  return React30.createElement(chakra.header, _extends5({
    ref,
    className: _className,
    id: headerId
  }, rest, {
...
var ModalBody = forwardRef(function(props, ref) {
  var className = props.className, rest = _objectWithoutPropertiesLoose5(props, _excluded4);
  ...
  var styles = useStyles();
  return React30.createElement(chakra.div, _extends5({
    ref,
    className: _className,
    id: bodyId
  }, rest, {
...
var ModalFooter = forwardRef(function(props, ref) {
  ...
  var styles = useStyles();
  var footerStyles = _extends5({
    display: "flex",
    alignItems: "center",
    justifyContent: "flex-end"
  }, styles.footer);
  return React30.createElement(chakra.footer, _extends5({
    ref
  }, rest, {
    __css: footerStyles,
    className: _className
...
var ModalCloseButton = forwardRef(function(props, ref) {
  ...
  var styles = useStyles();
  return React30.createElement(CloseButton, _extends5({
    ref,
...
function AlertDialog(props) {
  ...
  return React30.createElement(Modal, _extends5({}, rest, {
    initialFocusRef: leastDestructiveRef
  }));
}
var AlertDialogContent = forwardRef(function(props, ref) {
  return React30.createElement(ModalContent, _extends5({
    ref,
    role: "alertdialog"
  }, props));
});
...
function Drawer(props) {
  ...
  return React30.createElement(DrawerContextProvider, {
    value: {
      placement
    }
  }, React30.createElement(Modal, _extends5({
    isOpen,
    onClose,
...
var DrawerContent = forwardRef(function(props, ref) {
  ...
  return React30.createElement(chakra.div, _extends5({}, containerProps, {
    className: "chakra-modal__content-container",
    __css: dialogContainerStyles
  }), React30.createElement(ModalFocusScope, null, React30.createElement(StyledSlide, _extends5({
    direction: placement,
    "in": isOpen,
    className: _className
  }, dialogProps, {
...
***************************************************************************** */
//# sourceMappingURL=chunk-WQBUYVXW.js.map
